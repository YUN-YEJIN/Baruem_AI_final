...
BASE_DIR = r"/tongue2"
IMAGES_DIR = os.path.join(BASE_DIR, "../tongue2/image")
...
SEMIVOWEL_FILES = {
    'ㅣ_반모음': {'image': 'iiJ.png', 'landmarks': 'iiJ_manual_landmarks.json'},
    'ㅜ_반모음': {'image': 'eui-uuW.png', 'landmarks': 'eui-uuW_manual_landmarks.json'}
}

DIPHTHONG_MAPPING = {
    'ㅕ_혀': ('ㅣ_혀', 'ㅣ_반모음', 'ㅓ_혀'), 'ㅛ_혀': ('ㅣ_혀', 'ㅣ_반모음', 'ㅗ_혀'),
    'ㅠ_혀': ('ㅣ_혀', 'ㅣ_반모음', 'ㅜ_혀'), 'ㅑ_혀': ('ㅣ_혀', 'ㅣ_반모음', 'ㅏ_혀'),
    'ㅞ_혀': ('ㅜ_혀', 'ㅜ_반모음', 'ㅔ_혀'), 'ㅟ_혀': ('ㅜ_혀', 'ㅜ_반모음', 'ㅣ_혀'),
    'ㅝ_혀': ('ㅜ_혀', 'ㅜ_반모음', 'ㅓ_혀'), 'ㅘ_혀': ('ㅜ_혀', 'ㅜ_반모음', 'ㅏ_혀'),
    'ㅢ_혀': ('ㅡ_혀', 'ㅜ_반모음', 'ㅣ_혀'), 'ㅒ_혀': ('ㅣ_혀', 'ㅣ_반모음', 'ㅐ_혀'),
    'ㅖ_혀': ('ㅣ_혀', 'ㅣ_반모음', 'ㅔ_혀'), 'ㅕ_입': ('ㅣ_입', 'ㅣ_반모음', 'ㅓ_입'),
    'ㅛ_입': ('ㅣ_입', 'ㅣ_반모음', 'ㅗ_입'), 'ㅠ_입': ('ㅣ_입', 'ㅣ_반모음', 'ㅜ_입'),
    'ㅑ_입': ('ㅣ_입', 'ㅣ_반모음', 'ㅏ_입'),
}
...
def assemble_entry(label_key: str, mapping: Dict) -> Dict:
    ...
    if not entry and '_반모음_' in label_key:
        ...
        if len(parts) >= 3:
            try:
                return create_semivowel_entry(f"{parts[0]}_반모음", parts[2])
            except KeyError:
                pass
    if not entry:
